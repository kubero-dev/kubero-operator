...
{{- $registryUsername := (get $secretData "username") | default "asdf" }}
{{- $registryUsername }}
{{- end }}
{{- end }}
...
{{- $secretObj := (lookup "v1" "Secret" $mainnamespace "registry-login") | default dict }}
{{- $secretData := (get $secretObj "data") | default dict }}
{{- $registryPassword := (get $secretData "password") | default "asdf" }}
{{- $registryPassword }}
{{- end }}
{{- end }}
...
{{- $secretObj := (lookup "v1" "Secret" $mainnamespace "registry-login") | default dict }}
{{- $secretData := (get $secretObj "data") | default dict }}
{{- $dockerconfigjson := (get $secretData ".dockerconfigjson") | default "asdf" }}
{{- $dockerconfigjson }}
{{- end }}
{{- end }}