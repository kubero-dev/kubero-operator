...
# kubero.dev/kubero-operator-bundle:$VERSION and kubero.dev/kubero-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= kubero.dev/kubero-operator
...
ifeq (,$(shell which helm-operator 2>/dev/null))
	...
	curl -sSLo $(HELM_OPERATOR) https://github.com/operator-framework/operator-sdk/releases/download/v1.21.0/helm-operator_$(OS)_$(ARCH) ;\
